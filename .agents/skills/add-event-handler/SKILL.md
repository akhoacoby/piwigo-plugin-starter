...
# Add an event handler
 ...
 The canonical, tool-neutral instructions live in **`workflows/add-event-handler.md`** — read and follow that.

> Canonical: `workflows/add-event-handler.md`. Index of everything: `AGENTS.md`.
